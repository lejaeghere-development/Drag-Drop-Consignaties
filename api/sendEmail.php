...
$domainBase='https://www.apexexp.in/Games/Deliveryves/';//https://www.fit-it.be/krattenrek/
    ...
    $mail->isHTML(TRUE);
     ...
     if($_SESSION['loggedin']){ //  Condition where user is loggedin.
          $mail->Subject = 'Deliveryves: Jouw samengestelde consignatie';
               ...
               <head>
                    ...
                    <style type='text/css'>
                         ...
                         @font-face {
                               ...
                               src: url(".$domainBase."fonts/greycliff-medium.otf')
                          }
                      ...
                      <tr>
                         <td width='700' valign='top' align='center' style='background-repeat:no-repeat; background-size:cover;text-align: center;padding-bottom: 0px;width: 700px;padding-top: 60px;background-repeat: no-repeat;' class='full-width'>
                                             ...
                                             <table style='width: 700px;' width='700' cellpadding='0' cellspacing='0' border='0' class='full-width'>
                                                  <tr>
                                                       ...
                                                       <td style='width: 350px;vertical-align: middle;' width='350'>
                                                            <img class='img-fluid logo' src=".$domainBase."Email/Logo.png style='width: 350px;' width='350'>
                                                       </td>
                              ...
                              <table style='padding: 20px;  width: 700px;margin-bottom:100px;' width='700' cellpadding='0' cellspacing='0' border='0' class='full-width'>
                                  ...
                                  <tr>
                                        <td class='txt_regular black_txt sub' style='padding-bottom: 28px;'>
                                           Mooi gedaan! Je hebt net je drankenvoorraad in consignatie aangepast naar je wensen. Bij je volgende levering krijg je je nieuwe favoriete dranken.
                                       </td>
     
                                   <tr>
                                        <td class='txt_regular black_txt sub' style='padding-bottom: 20px; padding-top: 20px;'>
                                        Let wel: Een consignatiewijziging dient minimaal 2 werkdagen voor je volgende levering te worden doorgegeven.
                                        </td>
                                   </tr>
                                   <tr>
                                   <td class='txt_regular black_txt sub' style='padding-bottom: 20px;'>
                                             Adres: ".$decodeData->address."
                                             </td>
                                   </tr>
                                   <tr>
                                   ...
                                   <tr>
                                             ...
                                             <td style='text-align: center;' align='center'>
                                               <img class='img-fluid img-texto' src=".$domainBase."Email/".$_SESSION["uid"]."/".$decodeData->imageName.".png style='width: 700px;border: 1px solid #007892; border-radius: 10px;' width='500'>
          ...
          $mail->Subject = 'Deliveryves: Jouw consignatie wijziging';
          $mail->Body = "<html lang='en'>
          <head>
               <meta charset='utf8mb4'>
               <meta name='viewport' content='width=device-width, initial-scale=1'>
                         ...
                         <table style='padding: 20px;  width: 700px;margin-bottom:100px;' width='700' cellpadding='0' cellspacing='0' border='0' class='full-width'>
                             ...
                             <tr>
                              ...
                              <tr>
                                        ...
                                        <td style='text-align: center;' align='center'>
                                          <img class='img-fluid img-texto' src=".$domainBase."Email/".$decodeData->uid."/".$decodeData->imageName.".png style='width: 700px;border: 1px solid #007892; border-radius: 10px;' width='500'>
