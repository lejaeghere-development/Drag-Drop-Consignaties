...
export default class Intro extends Phaser.GameObjects.Group {
  ...
  setUp() {
    ...
    Global.emitter.on(
      ...
      this.hideCrateSelection.bind(this)
    );
  ...
  init() {
    ...
    this.title = this.create(
      this.c_w * 0.5,
      this.c_h * 0.5 - 400 * this.scaleFact,
      'items',
      'title0000'
    )
      .setDepth(1001)
  ...
  enableCrates() {
    ...
    this.subBG = this.create(
      this.c_w * 0.5,
      this.c_h * 0.5 - 100 * this.scaleFact,
      'items',
      'sub_bg0000'
    )
      .setDepth(1001)
      .setScale(this.scaleFact * 0.85);

    this.introTxt = this.scene.make
      .text({
        x: this.subBG.x,
        y: this.subBG.y,
        ...
        style: {
          font: Global.isMobile
            ? '' + String(50 * this.scaleFact) + 'px greycliff-medium'
            : '' + String(50 * this.scaleFact) + 'px greycliff-medium',
          fill: '#0A657A',
          align: 'center',
        },
    ...
    this.crate_6 = this.create(
      this.c_w * 0.5 - 1500 * this.scaleFact,
      this.c_h * 0.5 + 600 * this.scaleFact,
      'items',
      'crate_60000'
    )
      .setInteractive({
    ...
    this.crate_6_infoBG = this.create(
      this.c_w * 0.5 - 1500 * this.scaleFact,
      this.c_h * 0.5 + 800 * this.scaleFact,
      'items',
      'bottle_info_60000'
    )
      .setDepth(1000)
    ...
    this.crate_6_infoTxt = this.scene.make
      .text({
        ...
        style: {
          font: Global.isMobile
            ? '' + String(45 * this.scaleFact) + 'px greycliff-medium'
            : '' + String(45 * this.scaleFact) + 'px greycliff-medium',
          fill: '#ffffff',
          align: 'center',
        },
    ...
    this.crate_24 = this.create(
      this.c_w * 0.5 - 300 * this.scaleFact,
      this.c_h * 0.5 + 600 * this.scaleFact,
      'items',
      'crate_240000'
    )
    ...
    this.crate_24_infoBG = this.create(
      this.c_w * 0.5 - 300 * this.scaleFact,
      this.c_h * 0.5 + 800 * this.scaleFact,
      'items',
      'bottle_info_240000'
    ...
    this.crate_24_infoTxt = this.scene.make
      .text({
    ...
    this.crate_24_custom = this.create(
      this.c_w * 0.5 + 1200 * this.scaleFact,
      this.c_h * 0.5 + 600 * this.scaleFact,
      'items',
      'crate_240000'
    )
    ...
    this.infoIcon = this.create(
      this.crate_24_custom.x +
        this.crate_24_custom.width * this.crate_24_custom.scaleX * 0.4,
      this.crate_24_custom.y - 450 * this.scaleFact,
      'items',
      'infoBtn0000'
    )
    ...
    this.crate_24_custom_infoBG = this.create(
      this.c_w * 0.5 + 1200 * this.scaleFact,
      this.c_h * 0.5 + 800 * this.scaleFact,
      'items',
      'bottle_info_240000'
    ...
    this.crate_24custom_infoTxt = this.scene.make
      .text({
  ...
  onResize() {
    ...
    this.title &&
      this.title.scene &&
      this.title
        .setPosition(this.c_w * 0.5, this.c_h * 0.5 - 400 * this.scaleFact)
        .setScale(this.scaleFact * 0.8);

    this.subBG &&
      this.subBG.scene &&
      this.subBG
        .setPosition(this.c_w * 0.5, this.c_h * 0.5 - 100 * this.scaleFact)
        .setScale(this.scaleFact * 0.85);
    ...
    this.crate_6_infoTxt &&
      this.crate_6_infoTxt.scene &&
      this.crate_6_infoTxt
        .setPosition(
          this.crate_6_infoBG.x,
          this.crate_6_infoBG.y - 25 * this.scaleFact
        )
        .setFontSize(50 * this.scaleFact);
    ...
    this.crate_24_infoBG &&
      this.crate_24_infoBG.scene &&
      this.crate_24_infoBG
        .setPosition(
          this.c_w * 0.5 - 300 * this.scaleFact,
          this.c_h * 0.5 + 800 * this.scaleFact
    ...
    this.crate_24_infoTxt &&
      this.crate_24_infoTxt.scene &&
      this.crate_24_infoTxt
        .setPosition(
          this.crate_24_infoBG.x,
          this.crate_24_infoBG.y - 25 * this.scaleFact
        )
        .setFontSize(50 * this.scaleFact);

    this.crate_24_custom &&
      this.crate_24_custom.scene &&
      this.crate_24_custom
        .setPosition(
          this.c_w * 0.5 + 1200 * this.scaleFact,
          this.c_h * 0.5 + 600 * this.scaleFact
    ...
    this.crate_24_custom_infoBG &&
      this.crate_24_custom_infoBG.scene &&
      this.crate_24_custom_infoBG
        .setPosition(
          this.c_w * 0.5 + 1200 * this.scaleFact,
          this.c_h * 0.5 + 800 * this.scaleFact
    ...
    this.crate_24custom_infoTxt &&
      this.crate_24custom_infoTxt.scene &&
      this.crate_24custom_infoTxt
        .setPosition(
          this.crate_24_custom_infoBG.x,
          this.crate_24_custom_infoBG.y - 25 * this.scaleFact
        )
        .setFontSize(50 * this.scaleFact);
  }
  onSkip() {
