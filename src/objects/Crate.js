...
export default class Crates extends Phaser.GameObjects.Group {
    ...
    setUp() {
        ...
        Global.emitter.on('crate:remove_crate_bottle', this.removeBottle.bind(this));
        ...
        Global.emitter.on('drop_filled_crate_at', this.dropFilledCrateAt.bind(this))
        ...
        if (_frame.indexOf('group') != -1) {
            ...
            if (Global.crateType == "fixed") {
                ...
                for (let i = 1; i <= Global.totalBottles / 6; i++) {
                    ...
                    if ( this[`bottle_set${i}ToDrag`] && this[`bottle_set${i}ToDrag`].scene && this[`bottle_set${i}ToDrag`] !== gameObject) {
    ...
    onBottleDrag(pointer, gameObject, dragX, dragY) {
        ...
        if (this.bottleToDrag) {
            ...
            Global.emitter.emit('crate:check_on_drag', this.bottleToDrag.getBounds(), this.bottleToDrag.texture.key)
        }
        if ((gameObject == this.crate || gameObject == this.crateFront) && this.crateDragged) {
            ...
            Global.emitter.emit('rack:check_on_drag', this.crate.getBounds(), this.crate.frame.name)
            Global.emitter.emit('bin:check_on_drag', this.crate.getBounds(), this.crate.frame.name, 0.1)
    ...
    addCrate(byForce) {
        ...
        this.addCrateTO = setTimeout(() => {
            if (Global.totalBottles == 6) {
                this.bottleSets = 1;
                this.crate = this.create(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact /* this.c_w * .5 + 200 * this.scaleFact *-0.5 */ , this.c_h - this.extraTop - 400 * this.scaleFact, 'items', `crate_${Global.totalBottles}_back0000`)
                    .setDepth(11 + Global.extraDepth)
                    .setData('readyToDrag', true)
                    .setAlpha(0)
                    .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));
                this.crateFront = this.create(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact /* this.c_w * .5 + 200 * this.scaleFact *-0.5 */ , this.c_h - this.extraTop - 400 * this.scaleFact, 'items', `crate_${Global.totalBottles}_front0000`)
                ...
                this.bottleSets = 4;
                this.crate = this.create(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact /* this.c_w * .5 + 200 * this.scaleFact *-0.5 */ , this.c_h - this.extraTop - 400 * this.scaleFact, 'items', `crate_${Global.totalBottles}_10000`)
                    .setDepth(11 + Global.extraDepth)
                    .setAlpha(0)
                    .setData('readyToDrag', true)
                    .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));

                this.crateChannel1 = this.create(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact /* this.c_w * .5 + 200 * this.scaleFact *-0.5 */ , this.c_h - this.extraTop - 400 * this.scaleFact, 'items', `crate_${Global.totalBottles}_30000`)
                    .setDepth(13 + Global.extraDepth)
                    .setAlpha(0)
                    .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));

                this.crateChannel2 = this.create(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact /* this.c_w * .5 + 200 * this.scaleFact *-0.5 */ , this.c_h - this.extraTop - 400 * this.scaleFact, 'items', `crate_${Global.totalBottles}_70000`)
                    .setDepth(17 + Global.extraDepth)
                    .setAlpha(0)
                    .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));

                this.crateFront = this.create(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact /* this.c_w * .5 + 200 * this.scaleFact *-0.5 */ , this.c_h - this.extraTop - 400 * this.scaleFact, 'items', `crate_${Global.totalBottles}_80000`)
    ...
    removeCrate(callFinalCb = true) {
        ...
        this.scene.tweens.add({
            ...
            repeat: 0, // -1: infinity
            yoyo: false,
            onComplete: callFinalCb ? this.onDragRemoved.bind(this) : function () {
                this.clear(true, true);
            }.bind(this)
        });
    }
    ...
    dropFilledCrateAt(dropPos) {
        ...
        this.crate && this.crate.scene && this.crate.setPosition(dropPos.x, dropPos.y).setScale(this.crate.scaleX*.3);
        this.crateFront && this.crateFront.scene && this.crateFront.setPosition(dropPos.x, dropPos.y).setScale(this.crateFront.scaleX*.3);
        this.crateChannel1 && this.crateChannel1.scene && this.crateChannel1.setPosition(dropPos.x, dropPos.y).setScale(this.crateChannel1.scaleX*.3);
        this.crateChannel2 && this.crateChannel2.scene && this.crateChannel2.setPosition(dropPos.x, dropPos.y).setScale(this.crateChannel2.scaleX*.3);


        for (let i = 1; i <= this.bottleSets; i++) {
            this[`bottle_set${i}`] && this[`bottle_set${i}`].scene && this[`bottle_set${i}`].setPosition(this.crate.x, this.crate.y + (i - 2.5) * 150 * this.scaleFact / this.shrinkFact * (Global.totalBottles == 6 ? 0.7 : 0.85)*0.3)
                .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85)*0.3)
    ...
    onResize() {
        ...
        this.crate && this.crate.scene && this.crate.setPosition(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact, this.c_h - this.extraTop - 400 * this.scaleFact)
            .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));

        this.crateFront && this.crateFront.scene && this.crateFront.setPosition(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact, this.c_h - this.extraTop - 400 * this.scaleFact)
            .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));


        this.crateChannel1 && this.crateChannel1.scene && this.crateChannel1.setPosition(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact, this.c_h - this.extraTop - 400 * this.scaleFact)
            .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));

        this.crateChannel2 && this.crateChannel2.scene && this.crateChannel2.setPosition(this.extraLeftPer + this.extraTop / 4 + (Global.lastOrientation == "portrait" ? 1100 : 700) * this.scaleFact, this.c_h - this.extraTop - 400 * this.scaleFact)
            .setScale(this.scaleFact * 1.5 * (Global.totalBottles == 6 ? 1 : 0.85));
