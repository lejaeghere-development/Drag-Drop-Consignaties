...
const webpackConfig = {
  entry: {
    ...
    forgotPassword: [
      '@babel/polyfill',
      path.resolve(__dirname, 'src/forgotPassword.js'),
    ],
    changePassword: [
      '@babel/polyfill',
      path.resolve(__dirname, 'src/changePassword.js'),
    ],
    recoverPassword: [
      '@babel/polyfill',
      path.resolve(__dirname, 'src/recoverPassword.js'),
    ],
    addressBook: [
      '@babel/polyfill',
      path.resolve(__dirname, 'src/addressBook.js'),
    ],
    customCrate: [
      '@babel/polyfill',
      path.resolve(__dirname, 'src/customCrate.js'),
    ],
  },
  output: {
    path: !isProduction
  ...
  plugins: [
    ...
    new HtmlWebpackPlugin({
      template: './customCrate.html',
      filename: 'customCrate.html',
      chunks: ['customCrate'],
    }),
